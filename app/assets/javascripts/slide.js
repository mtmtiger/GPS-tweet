  ...
  $(function(){
    ...
    function slideTimer(){
      if(count != 1 || 0){
        ...
        $("#image-btn img").removeClass("target")
        $("#image-btn:nth-child(" + current + ") img").addClass("target")
      }
    }
    ...
    $(document).on('mouseenter', '#slide-lists', function(){
      $("#image-btn-list").animate({opacity: "1"}, 300)
    });
    $(document).on('mouseleave', '#slide-lists', function(){
      $("#image-btn-list").animate({opacity: "0"}, 300)
    });
